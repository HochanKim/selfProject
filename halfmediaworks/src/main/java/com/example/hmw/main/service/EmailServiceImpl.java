...
//		System.out.println("인증 번호 : " + ePw);
		...
		msgg += "<h1> 안녕하세요</h1>";
		msgg += "<h1> HalfMediaWorks 입니다</h1>";
		msgg += "<br>";
		msgg += "<p>아래 코드를 입력해주시길 바랍니다.<p>";
		msgg += "<br>";
		...
		message.setFrom(new InternetAddress("ghckskim@gmail.com", "하프미디어웍스"));		// 보내는 사람
